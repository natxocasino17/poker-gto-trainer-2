...
const List<TableBackground> kTableBackgrounds = [
  ...
  TableBackground('Tropical', 'assets/backgrounds/tropical.png', seatSpread: 1.06),
  TableBackground('Neón', 'assets/backgrounds/neon.png', seatSpread: 1.06),
  TableBackground('Lujo', 'assets/backgrounds/luxury.png', seatSpread: 1.06),
  TableBackground('Terciopelo', 'assets/backgrounds/bg1.png', scale: 0.85, seatSpread: 1.18),
  TableBackground('Minimal', 'assets/backgrounds/bg2.png', scale: 0.80, seatSpread: 1.18),
  TableBackground('Saloon', 'assets/backgrounds/bg3.png', scale: 1.05, seatSpread: 1.06),
  TableBackground('Espacial', 'assets/backgrounds/bg4.png', scale: 0.82, seatSpread: 1.18),
  TableBackground('Yate', 'assets/backgrounds/bg5.png', scale: 0.98, seatSpread: 1.06),
  TableBackground('Arcade', 'assets/backgrounds/bg6.png', scale: 1.08, seatSpread: 1.03),
  TableBackground('Steampunk', 'assets/backgrounds/bg7.png', scale: 0.92, seatSpread: 1.18),
];
